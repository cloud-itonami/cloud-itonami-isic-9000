# Operator Quickstart — Creative, arts and entertainment activities

Shortest path from clone to a verified local dry-run for **ISIC 9000** (`cloud-itonami-isic-9000`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9000.git
cd cloud-itonami-isic-9000
```
...
- Blueprint governor key: `content-and-booking-governor`
- Likely source path: `entertainment.governor.cljc`
